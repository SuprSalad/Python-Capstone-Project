...
with open('assets/wordle-Ta.txt', 'r') as file:
    
    file_words = file.readlines()
    WORDS = [line.strip() for line in file_words]
...
with open('assets/wordle-La.txt', 'r') as file:
    
    file_words = file.readlines()
    POSSIBLE_WORDS = [line.strip() for line in file_words]
    ...
    for i in range(5):
        ...
        if lowercase_letter in CORRECT_WORD:
            if lowercase_letter == CORRECT_WORD[i]:
                ...
                if not game_decided:
                    game_result = "W"
            elif lowercase_letter in double_letters:
            ...
            game_result = ""
            game_decided = True
        double_letters += lowercase_letter
